...
public class X_HR_PaymentSelection extends PO implements I_HR_PaymentSelection, I_Persistent 
{
    ...
    /** Load Constructor */
    public X_HR_PaymentSelection (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_HR_PaymentSelection[")
	...
	/** Set GenLines.
		@param GenLines GenLines	  */
	public void setGenLines (String GenLines)
	{
		set_Value (COLUMNNAME_GenLines, GenLines);
	}
	...
	public void setHR_PaymentSelection_ID (int HR_PaymentSelection_ID)
	{
		if (HR_PaymentSelection_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_HR_PaymentSelection_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_HR_PaymentSelection_ID, Integer.valueOf(HR_PaymentSelection_ID));
	}
	...
	/** Set HR_PaymentSelection_UU.
		@param HR_PaymentSelection_UU HR_PaymentSelection_UU	  */
	public void setHR_PaymentSelection_UU (String HR_PaymentSelection_UU)
	{
		set_Value (COLUMNNAME_HR_PaymentSelection_UU, HR_PaymentSelection_UU);
	}

	/** Get HR_PaymentSelection_UU.
		@return HR_PaymentSelection_UU	  */
	public String getHR_PaymentSelection_UU () 
	{
		return (String)get_Value(COLUMNNAME_HR_PaymentSelection_UU);
	}
