...
public class PaymentSelection extends CustomProcess {
	...
	protected String doIt() throws Exception {
		...
		Integer HR_Concept_ID = MSysConfig.getIntValue("ConceptForPayment", 0, getAD_Client_ID());
		if (HR_Concept_ID==0)
			throw new AdempiereException("Debe crear el Sysconfig ConceptForPayment "
					+ "especificando el id del concepto CC_TOTAL_ASIGNACION-DEDUCCION");
